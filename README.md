Crypto Webminer | Electroneum | Monero | Bytecoin | IntenseCoin | Dinastycoin | Graft | SuperiorCoin | Turtlecoin | Stellite | IPBC Coin | DERO | Qwertycoin | Aeon | Cryptonight | Cryptonight-Lite | Custom Pool Support - Mining in your Browser
...
<br><br>
Attention: Special Case for some custom variant fork coins: Intensecoin Electroneum need ?algo=cn?variant=1
Attention: ETN Cryptonight ?algo=cn?variant=1 ---> 07.06.18 | FORK ---> use variant=1 now
Attention: Stellite and IPBC created their own PoW variants....so mining is disabled for the moment
<br><br>
