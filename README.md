...
#### Examples: Zpool Flex Algo - DASH Payout (flex algo most profitable) in gutav.js password field should c=DASH | or any other payout coin, check out the pool website for more details ;) <br> need ?algo=flex/native<br>
```sh
